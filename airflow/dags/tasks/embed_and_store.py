...
# Minimal placeholder embedding using simple hashing so we avoid heavyweight libs for now
...
def store_in_vector_db(embedded_papers: list) -> str:
    ...
    """
    # TODO: connect to actual vector database (e.g., PostgreSQL + pgvector / Chroma / Weaviate)
